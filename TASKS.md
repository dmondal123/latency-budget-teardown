...
- [ ] Pass text, image, memory, swap, and multimodal prefix-cache feasibility probes. Automated M05 evidence runner and local tests implemented; target-device run pending. — `gpt-5.6-terra`, medium

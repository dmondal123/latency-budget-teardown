---
name: chose-graders-and-metrics
description: Use when designing evaluation cases, choosing grader layers, or setting metrics and release gates for evaluation datasets
---
...
For grader-layer selection and metric protocols, see [grader-stack-reference.md](references/grader-stack-reference.md).

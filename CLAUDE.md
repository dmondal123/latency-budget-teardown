...
This project is indexed by GitNexus as **latency-budget-teardown** (2428 symbols, 2436 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

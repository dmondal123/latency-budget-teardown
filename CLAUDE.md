...
This project is indexed by GitNexus as **latency-budget-teardown** (2465 symbols, 2476 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
This project is indexed by GitNexus as **latency-budget-teardown** (2519 symbols, 2566 relationships, 4 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
